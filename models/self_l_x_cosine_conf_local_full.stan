...
model{
    ...
    for (i in 1:N){
        ...
        collective_mu[k] = col_a +
            ...
            col_b4 * local_alignment_confidence[k] * self_l[k] +
            col_b5 * cosine_word_set[k] * self_l[k] +
            col_b6 * cosine_word_set[k] * local_alignment_confidence[k] +
            col_b7 * cosine_word_set[k] * local_alignment_confidence[k] * self_l[k];
